   ...
   {({ loggedIn }) => (
    <>
     {loggedIn ? (
      ...
      <div className="inset-0 z-50 min-h-[70vh] bg-back flex justify-center overflow-y-auto py-20">
       <div className="bg-white w-full max-w-3xl p-8 rounded-lg shadow-lg">
        <h1 className="text-2xl font-semibold">Add Donation</h1>
        <p className="mt-7 text-lg text-gray-500">
           Please <Link to="/login" className="text-blue-500">login</Link> to add a donation.
        </p>
       </div>
      </div>
     )}
