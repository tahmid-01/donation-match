const Hero = () => {
 return (
  <section className="w-full max-w-7xl px-4 lg:px-8 mx-auto hero-section py-12 md:py-24">
   <div className="w-full grid lg:grid-cols-2 gap-8 justify-between items-center">
    {/* Left Side: Text */}
    <div className="text-content leading-[1.2]">
     <h1
      className="text-5xl xl:text-6xl tracking-tighter font-[800] text-black"
      id="home--hero-title"
     >
     ...
     <p
      className="mt-6 leading-6 text-gray-600 max-w-[400px]"
      id="home--hero-desc"
     >
    ...
    <div className="grid sm:grid-cols-2 gap-4 lg:gap-12 h-[90%] whitespace-nowrap">
     <div
      className="card flex flex-col items-center justify-center bg-white rounded-lg shadow-md px-14 xl:px-16 h-fit xl:h-full py-14 xl:py-0 text-center"
      id="home--hero-box"
     >
